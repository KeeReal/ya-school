...
var INPUT_NAMES_KEYS = _.values(INPUT_NAMES);
...
(function initializeInputs() {
    _.each(consts.ALL_FIELD_NAMES, function (name) {
        var selector = "input[name=\"" + name + "\"]";
        var input = myForm.find(selector);
...
exports.getInputValue = function (name) {
...
exports.getFormAction = function () {
    return myForm.attr("action");
};

exports.setFieldInvalid = function (name) {
    return setInvalidState(name);
};

exports.resetFieldStates = function () {
    return _.each(consts.ALL_FIELD_NAMES, function (name) {
        return setValidState(name);
    });
};

exports.lockSendButton = function () {
    return myForm.find("#submit").prop("disabled", true);
};

exports.unlockSendButton = function () {
    return myForm.find("#submit").prop("disabled", false);
};
...
var MyForm = __webpack_require__(5);
...
var formModel = __webpack_require__(8);
var formView = __webpack_require__(3);
var resultView = __webpack_require__(9);
...
exports.validate = function () {
    ...
    _.each(consts.ALL_FIELD_NAMES, function (fieldName) {
        var r = validator.isFieldValueValid(fieldName, formModel.getValue(fieldName));
        if (!r.valid) {
            isValid = false;
...
exports.submit = function () {
    ...
    var v = exports.validate();

    if (!v.isValid) {
        _.each(v.errorFields, function (name) {
            return formView.setFieldInvalid(name);
        });
        return;
    }

    var action = formView.getFormAction();
...
var emailValidator = __webpack_require__(7);
var consts = __webpack_require__(1);

var ValidationResult = function () {
    _createClass(ValidationResult, null, [{
        key: "invalid",
    ...
    function ValidationResult(valid) {
 ...
 * @returns {ValidationResult}
 */
exports.isFieldValueValid = function (name, value) {
    switch (name) {
 ...
 * @returns {ValidationResult}
 */
exports.isFullNameValid = function (fullName) {
...
exports.isEmailValid = function (email) {
    ...
    var DOMAIN_RE = /@([\w.]+)$/ig;
    var result = DOMAIN_RE.exec(email);
    if (!result) {
        throw new Error("Are you kidding me!?");
    }

    // todo: regexp?
    var ALLOWED_DOMAINS = ["ya.ru", "yandex.ru", "yandex.ua", "yandex.by", "yandex.kz", "yandex.com"];
    var domain = (result[1] || "").toLowerCase();
 ...
 * @returns {ValidationResult}
 */
exports.isTelValid = function (tel) {
...
exports.getValue = function (fieldName) {
    return formView.getInputValue(fieldName);
};

exports.setData = function (data) {
    if (_.isObject(data)) {
        _.each(consts.ALL_FIELD_NAMES, function (name) {
            return formView.setInputValue(name, data[name]);
        });
    }
};

exports.getData = function () {
    return _.reduce(consts.ALL_FIELD_NAMES, function (memo, name) {
...
var results = $("div#resultContainer");
if (results.length === 0) {
...
exports.setSuccess = function () {
    resetClasses();
    results.addClass("success");
};

exports.setProgress = function () {
    resetClasses();
